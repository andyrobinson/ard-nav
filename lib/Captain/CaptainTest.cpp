...
namespace {
  ...
  TEST_F(CaptainTest, Should_be_able_to_save_destinations_in_the_mock) {
    waypoint first = {"first", {10.0, 10.0, 1.0}};
    waypoint second = {"second", {11.0, 11.0, 1.0}};
  ...
  TEST_F(CaptainTest, Should_navigate_to_the_first_waypoint) {
    waypoint first = {"first", {-10.0, -20.0, 1.0}};
  ...
  TEST_F(CaptainTest, Should_navigate_to_each_waypoint_in_turn) {
    waypoint first = {"first", {-10.0, -20.0, 1.0}};
    waypoint second = {"second", {-12.0, -22.0, 1.0}};
    waypoint third = {"third", {-13.0, -24.0, 1.0}};

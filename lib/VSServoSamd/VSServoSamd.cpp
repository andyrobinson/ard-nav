...
uint8_t VSServoSamd::attach(int pin)
{
  return this->attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
}

uint8_t VSServoSamd::attach(int pin, int min, int max)
{
...
void VSServoSamd::write(int value, uint8_t speed) {
    ...
    writeMicroseconds(value, speed);
}

void VSServoSamd::writeMicroseconds(int value) {
  writeMicroseconds(value,0);
}

void VSServoSamd::writeMicroseconds(int value, uint8_t speed)
{
...
int VSServoSamd::read() // return the value as degrees
{
  return map(readMicroseconds()+1, SERVO_MIN(), SERVO_MAX(), 0, 180);
}

int VSServoSamd::readMicroseconds()
{

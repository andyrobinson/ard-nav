...
#ifndef VSServoSamd_h
#define VSServoSamd_h
...
private:
  void writeMicroseconds(int value, uint8_t speed); // Write pulse width in microseconds, with speed value
